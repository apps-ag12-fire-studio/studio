...
const ExtractContractDataOutputSchema = z.object({
  ...
  valorPrincipal: z.string().optional().describe('Valor principal do contrato e condições de pagamento, se houver (ex: "R$ 1.200,00 (mil e duzentos reais) mensais", "Preço total de R$ 50.000,00 a ser pago em 5 parcelas de R$ 10.000,00").'),
  ...
  outrasObservacoesRelevantes: z.string().optional().describe('Quaisquer outras cláusulas ou observações que pareçam especialmente relevantes ou incomuns.'),
});
...
Priorize a fidelidade ao texto do contrato.
